...
public class HttpDownload {
    public String toLink(@XPath("/doc/str[@name='file_name']") final String fileName,
        ...
        final Pattern regex = Pattern.compile("FULINS_[FSHIJM]_", Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CASE);
        return regex
                .matcher(fileName)
                .find() || fileName.startsWith("DLTINS_") ? link : null;
    }
}
//end::HttpDownload[]
